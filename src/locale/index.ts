const i18n = {
  'en-US': {
    ...
    'menu.user.documents': 'Knowledge Management',
    'menu.user.ammunitionDetail': 'Ammunition Detail',
    'menu.user.artilleryDetail': 'Artillery Detail',
    'menu.user.productCompare': 'Product Compare',
    'menu.user.aiChat': 'AI Chat',
    ...
    'menu.knowledge': 'Knowledge Management',
    'menu.knowledge.documents': 'Documents',
  ...
  'zh-CN': {
    ...
    'menu.user.documents': '知识管理',
    'menu.user.ammunitionDetail': '弹药详情',
    'menu.user.artilleryDetail': '火炮详情',
    'menu.user.productCompare': '产品对比',
    'menu.user.aiChat': 'AI问答',
